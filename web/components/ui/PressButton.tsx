...
const variantClasses: Record<Variant, string> = {
  primary:
    "bg-sage-700 text-ink-900 [@media(hover:hover)_and_(pointer:fine)]:hover:bg-sage-600",
  secondary:
  ...
  danger:
    "bg-claret-600 text-ink-900 [@media(hover:hover)_and_(pointer:fine)]:hover:bg-[#711f28]",
};
